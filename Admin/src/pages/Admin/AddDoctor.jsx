...
const AddDoctor = () => {
  return (
    <form className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80h] overflow-y-scroll">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              <p>Experience</p>
              <select className="border rounded px-3 py-2" name="experience" id="experience">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <p>Speciality</p>
              <select className="border rounded px-3 py-2" name="speciality" id="speciality">
